...
namespace WizServ
{
    public partial class PartsOnOrder : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            /*
            TextWriter txt = new StreamWriter("I:\\Datafile\\Doc\\PriPartsOnOrder.txt");
            txt.Write(richTextBox1.Text);
            txt.Close();
            var fileToOpen = "I:\\Datafile\\Doc\\PriPartsOnOrder.txt";
        ...
        public void GetData()
        {
            ...
            {
                MessageBox.Show("Error 283: Sorry an error has occured: " + ex.Message);
            }
        }
    }
}
