...
namespace WizServ
{
    public partial class PartsUsedThisYear : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            TextWriter txt = new StreamWriter("I:\\Datafile\\Doc\\PriPartsThisYear.txt");
            txt.Write(richTextBox1.Text);
            txt.Close();
            var fileToOpen = "I:\\Datafile\\Doc\\PriPartsThisYear.txt";
