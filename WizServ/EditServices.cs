...
namespace WizServ
{
    public partial class EditServices : Form
    {
        ...
        private int loopCount, loop, charCountLine2;
        private string IsClosed = "", a, b;
        public bool Found = false;
        private SoundPlayer Player = new SoundPlayer();
        public string IsWarranty, TheBrand, s;
        public bool IsError = false;
        public double timertik;
        ...
        public EditServices()
        {
            ...
            Text = "Edit Service Data - Claim by Claim Number - Page 1";
            ClearButLabels();
            GetData();
            if (Found == false)
            {
        ...
        public void UpdateServicesData()
        {
            ...
            if (File.Exists(Database))
            {
                ...
                {
                    MessageBox.Show("Error line 151: \n" + ex);
                }
            }
        }
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            //MessageBox.Show(a + " Length= "+ a.Length.ToString());
        }
        ...
        public void GetData()
        {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (claim_no.Length == 6)
                    {
                        if (mClaim_NO == claim_no)
                        {
                            ...
                            if (textBox4.Text.StartsWith("ESTIMATE"))
                            {
                                label46.BackColor = Color.White;
                                label46.ForeColor = Color.Green;
                                label46.Text = " ESTIMATE ";
                                label46.BackColor = Color.White;
                                parts = false;
                            }
                            if (textBox3.Text.Contains("PT.#"))
            ...
            {
                MessageBox.Show("Error 1243: Sorry an error has occured: " + ex.Message);
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)      // Save New Data
        {
            UpdateServicesData();
            if (textBox3.Text.Contains("PT#"))
            {
        ...
        private void button1_Click(object sender, EventArgs e)      // Page 2
        {
            UpdateServicesData();
            Version.From = "EditServices";
            Hide();
