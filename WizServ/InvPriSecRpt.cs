...
namespace WizServ
{
    public partial class InvPriSecRpt : Form
    {
        public Icon image100 = Properties.Resources.WizServ;
        private readonly string PrimaryParts = @"I:\\datafile\\Control\\part_sec.csv";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (printcount == 1)
            {
                richTextBox1.Text = "Part #\t\t\t\tLast Used\t\tQty Ord.\tDate Ord.\t\tCost EA.\tMS-CODE\n\n" + richTextBox1.Text;
            }
            string saveFile1 = @"C:\\_WizServ_Reports\\InvSecReport.rtf";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            TextWriter txt = new StreamWriter("I:\\Datafile\\Doc\\InvSecReport.txt");
            txt.Write(richTextBox1.Text);
            txt.Close();
            var fileToOpen = "I:\\Datafile\\Doc\\InvSecReport.txt";
        ...
        public void GetData()
        {
            ...
            try
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (ONHAND <= LOWLIMIT)
                    {
                        ...
                        var mscode = listN[loopCount].ToUpper();
                        if (mscode.Contains("NONE"))
                        {
                            mscode = " ";
                        }
                        richTextBox1.Text = richTextBox1.Text + Part_Num + "\t\t" + last_used_date + "\t\t" + listK[loopCount] + "\t\t" + Ordered_date + "\t\t" + Convert.ToDecimal(listE[loopCount]).ToString("C2") + "\t\t" + mscode + "\n";
                        loop++;
            ...
            {
                MessageBox.Show("Error 314: Sorry an error has occured: " + ex.Message);
            }
        }
    }
}
