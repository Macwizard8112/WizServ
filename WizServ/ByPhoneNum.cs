...
namespace WizServ
{
    public partial class ByPhoneNum : Form
    {
        ...
        public ByPhoneNum()
        {
            ...
            GetData();
            DisplayIfOnlyOneListed();
        }

        public void DisplayIfOnlyOneListed()
        {
            if (loop == 1)
            {
                this.Hide();
                var SelectedText = claim_no;
        ...
        public void GetData()
        {
            try
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (listJ[loopCount].Contains(claim_no))
                    {
                        claim_no = listB[loopCount];
