...
namespace WizServ
{
    public partial class EditClaim : Form
    {
        ...
        public bool kyprssed;

        public EditClaim() 
        {
            InitializeComponent();
            if (computerDescription == "PARTS3" || computerDescription == "PARTS1") 
            {
        ...
        private void textBox2_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Last Name can not be blank.");
                textBox2.Select();
            }
        }
        ...
        private void textBox4_Leave(object sender, EventArgs e)
        {
            ...
            if (textBox4.Text == ".")
            {
                MessageBox.Show("City can not be blank.");
                textBox4.Select();
            }
            textBox5.Select();
        }
        ...
        private void textBox3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Tab && kyprssed == false)
            {
                textBox4.Select();
        ...
        public void GetData()
        {
            ...
            try
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (listB[loopCount].Contains(claim_no)) 
                    {
                        ...
                        decimal value = 0.00m;  
                        decimal d = decimal.Parse(mbv);
                        label33.Text = d.ToString("C2");    // Convert text to decimal w/ $

                        decimal d1 = decimal.Parse(mbw);
                        label34.Text = d1.ToString("C2");   // Convert text to decimal w/ $
                        decimal d2 = d1 - value;
                        if (d1 >= 100m)
                        {
                            label36.Text = d1.ToString("C2");
                        }
                        else
                        {
                            label36.Text = value.ToString("C2");
                        }
                        //label36.Text = d2.ToString("C2");   // Convert text to decimal w/ $ Amount to Collect $
                        if (mbu == "Y") 
                        {
                        ...
                        if (button1WasClicked == true)
                        {
                            ...
                            textBox3.Text = listL[loopCount];
                            textBox28.Visible = false;
                            textBox27.Visible = false;
                            textBox36.Text = listAE[loopCount];
            ...
            {
                MessageBox.Show("Error 951: Sorry an error has occured: " + ex.Message);
            }
        }
                        ...
                        if (line.Contains(","))
                        {
                            ...
                            try
                            {
                                if (split[1].Contains(claim_no))
                                {
                                    ...
                                    split[11] = textBox3.Text;
                                    
                                    split[30] = textBox36.Text;
                                    split[31] = textBox29.Text;
