...
namespace WizServ
{
    public partial class ByStreetName : Form
    {
        ...
        public void GetData()
        {
            try
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (listF[loopCount].Contains(claim_no))
                    {
                        ...
                        if (hh.Length <= 20)
                        {
                            if (kk.Length <= 16)
                            {
                                richTextBox1.Text = richTextBox1.Text + listB[loopCount] + "\t\t" + listE[loopCount] + ", " + listD[loopCount] + "\t\t\t" + listG[loopCount] + "\t\t" + listH[loopCount] + "\t\t" + listBB[loopCount] + "\t\t" + listF[loopCount] + "\n";
                            }
                            else
                            {
                                richTextBox1.Text = richTextBox1.Text + listB[loopCount] + "\t" + listE[loopCount] + ", " + listD[loopCount] + "\t\t\t" + listG[loopCount] + "\t" + listH[loopCount] + "\t" + listBB[loopCount] + "\t\t" + listF[loopCount] + "\n";
            ...
            {
                MessageBox.Show("Error 199: Sorry an error has occured: " + ex.Message);
            }
        }
