...
namespace WizServ
{
    public partial class UndeleteGoldMember : Form
    {
        ...
        public UndeleteGoldMember()
        {
            InitializeComponent(); BackColor = Color.FromArgb(0, 132, 129);
            Icon = image100;
            MaximizeBox = false;
            MinimizeBox = true;
            ControlBox = true;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                {
                    label12.Text = "Yes, Is marked for Undeletion.\nPLEASE PRESS RETURN BUTTON.";
                    UpdateGold();
                ...
                {
                    label12.Text = "No, Not marked for Undeletion.\nPLEASE PRESS RETURN BUTTON.";
                    UpdateGold();
                    label10.Visible = true;
                }
        }
        ...
        public void DisplayList()
        {
            try
            {
                ...
                if (loop == 0)
                {
                    richTextBox1.Font = new Font("Tahoma", 16, FontStyle.Bold);
                    richTextBox1.Text = richTextBox1.Text + "\n\nNone found, Press RETURN";
                    found = false;
                }
