...
namespace WizServ
{
    public partial class ClaimsAssigned : Form
    {
        ...
        private void SetLabels()
        {
            if (FROM == "ASSIGNED")
            {
                label1.Text = "Claims Needing to be Assigned:";
            }
            if (FROM == "RECEIVED")
            {
                label1.Text = "                       Claims Received:";
            }
        }

        private void button1_Click(object sender, EventArgs e)
        {
            Version.ClaimsPassThru = 0;
            Version.From = "";
            Hide();
        ...
        public void GetData()
        {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    if (FROM == "ASSIGNED")
                    {
                        if (mBench.Contains("ASSIGNED"))
                        {
                            ...
                            richTextBox1.Text = richTextBox1.Text + mClaim_NO + "\t" + mDate_IN + "\t" + mBrand + "\t" + mModel + "\n";
                        }
                    }
                    if (FROM == "RECEIVED")
                    {
                        ...
                        {
                            richTextBox1.Text = richTextBox1.Text + mClaim_NO + "\t" + closed + "\t" + mDate_IN + "\t" + mBrand + "\t" + mModel + "\n";

                        }
                        else
                        {
                            richTextBox1.Text = richTextBox1.Text + mClaim_NO + "\t" + open + "\t" + mDate_IN + "\t" + mBrand + "\t" + mModel + "\n";
                        }
                    }
            ...
            {
                MessageBox.Show("Error 813: Sorry an error has occured: " + ex.Message);
            }
        }
    }
}
